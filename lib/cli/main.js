...
var bitgreennode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = bitgreennode.version;
  var create = bitgreennode.scaffold.create;
  var add = bitgreennode.scaffold.add;
  var start = bitgreennode.scaffold.start;
  var remove = bitgreennode.scaffold.remove;
  var callMethod = bitgreennode.scaffold.callMethod;
  var findConfig = bitgreennode.scaffold.findConfig;
  var defaultConfig = bitgreennode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Bitgreen database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitgreen-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitgreen-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitgreen-node add wallet-service');
      console.log('    $ bitgreen-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitgreen-node remove wallet-service');
      console.log('    $ bitgreen-node remove insight-api');
      console.log();
    });
